...
export faust="" # faustian bargain to run fs without flock
export dir_here=$(pwd)
...
echo ""
echo "mv ${dir_here}/${host_name}/spack-setup.out topa/spack-setup-${ymd}.out"
      mv ${dir_here}/${host_name}/spack-setup.out topa/spack-setup-${ymd}.out
