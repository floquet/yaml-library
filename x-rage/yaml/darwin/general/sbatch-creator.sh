...
export dir_spack="darwin-general-xrage.spack"
...
echo "cd /scratch/users/dantopa/repos/spack/xrage/general"
      cd /scratch/users/dantopa/repos/spack/xrage/general
...
echo "cd /scratch/users/dantopa/repos/github/yaml-library/x-rage/darwin/general"
      cd /scratch/users/dantopa/repos/github/yaml-library/x-rage/darwin/general
